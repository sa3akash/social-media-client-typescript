...
const SujestedPage = () => {
  return (
    ...
    <div className="flex items-center justify-between px-4 py-4 ">
      ...
      <div className='font-semibold text-[14px] uppercase cursor-pointer select-none'>See All</div>
    </div>
    <Separator />
    ...
    <div className="w-full flex items-center gap-4 cursor-pointer">
      ...
      <div className="flex flex-col">
        ...
        <span className="text-[12px] text-[#696974] roboto">Design Studio</span>
      </div>
    </div>

    <div className='h-[232px] rounded-xl borderWrapper'>
          <div className='h-[75%] bg-green-400'></div>
          <div className='h-[25%] flex items-center justify-center gap-2 cursor-pointer'>
            <img src={LikeThumbIcon} alt="icon" />
            <span className='text-[14px] roboto tracking-[0.1px] text-[#D5D5DC]'>Like Page</span>
          </div>
    </div>
