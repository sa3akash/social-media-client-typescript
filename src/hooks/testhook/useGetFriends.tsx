...
import { useGetFriendsUsersQuery } from "@/store/rtk/friends/friendsSlice";
import { useEffect, useState, useRef, useCallback } from "react";

export const useInfiniteFriends = (uri: string) => {
  ...
  const { data, isFetching, isError } = useGetFriendsUsersQuery({ uri, page });
